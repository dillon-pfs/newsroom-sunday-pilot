    ...
    <div className="space-y-6">
      <section className="max-w-3xl space-y-2">
        ...
        <h1 className="font-heading text-3xl font-semibold tracking-tight sm:text-4xl">
          Three DEMO games own the board.
        </h1>
        <p className="text-sm leading-6 text-ink-soft sm:text-base">
          Public seed is three labeled backtests: 49ers 27–Rams 7, Giants
          28–Cowboys 20, Chiefs 31–Broncos 10. Chip Absolute leads. SATIRE is
          Editor-approved and labeled. The SIMULATED desk tape is not on this
          page.
        </p>
      </section>
