...
export const simulatedBeats: SimulatedBeat[] = [
  ...
  },
  {
    ...
    kind: "fact",
    authorId: null,
    headline: "SIMULATED: Greyshirts first down",
  ...
  },
  {
    ...
    gameId: SIMULATED_GAME_ID,
    kind: "commentary",
    authorId: "chip-absolute",
    headline: "Chip Absolute",
    body: "Hold the megaphone — I don’t yell touchdown at midfield chalk. Official spot first, chaos second.",
    postedAtLabel: "0:08",
    path: "simulated-review",
    atMs: 8_000,
    clockLabel: "Q1 12:40",
  ...
  },
  {
    ...
    kind: "correction",
    authorId: null,
    headline: "SIMULATED correction: spot was the 48",
  ...
  },
  {
    ...
    kind: "fact",
    authorId: null,
    headline: "SIMULATED: Red Caps score",
  ...
  },
  {
    ...
    authorId: "chip-absolute",
    headline: "Chip Absolute",
    body: "Updates delayed? Fine. I’m not inventing the next seven just to keep the timeline dancing.",
    postedAtLabel: "0:22",
    path: "simulated-review",
    atMs: 22_000,
    clockLabel: "Q1 6:05",
  ...
  },
  {
    ...
    kind: "fact",
    authorId: null,
    headline: "SIMULATED: Greyshirts answer",
