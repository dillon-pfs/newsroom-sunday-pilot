...
export const simulatedBeats: SimulatedBeat[] = [
  ...
  },
  {
    ...
    kind: "fact",
    authorId: null,
    headline: "SIMULATED / Desk: Greyshirts first down",
  ...
  },
  {
    ...
    kind: "status",
    authorId: null,
    headline: "Desk: wait for the official spot",
  ...
  },
  {
    ...
    body: "TODO_LEAD_COPY — placeholder hot take. No live score, player, penalty, or play.",
    postedAtLabel: "0:08",
    path: "simulated-review",
    atMs: 8_400,
    clockLabel: "Q1 12:40",
  ...
  },
  {
    ...
    kind: "correction",
    authorId: null,
    headline: "SIMULATED / Desk: Correction — spot was the 48",
  ...
  },
  {
    ...
    kind: "status",
    authorId: null,
    headline: "Desk: delayed is honest",
