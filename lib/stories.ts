...
export const stories: Story[] = [
  {
    slug: "whats-ahead-lions-at-bills",
    title: "What’s Ahead: Lions at Bills — Ceremony Meets a Visiting Spoiler",
    dek: "TNF at Highmark — Chip Absolute on a building that wants a coronation and a Lions visitor that does not have to clap along.",
    dateLabel: "Sep 17, 2026",
    voiceId: "chip-absolute",
    body: [
      {
        kind: "p",
        text: "Poor Form Desk is not here to hand you a money line. We are here to hand Chip Absolute a building that wants a coronation and a visitor that does not have to clap along.",
      },
      {
        kind: "p",
        text: "Buffalo opens the regular-season book on a new Highmark night. That is real ceremony energy: ribbons, volume, the timeline treating architecture like a defensive coordinator. Chip’s job is not to mock the building. Chip’s job is to notice when the building starts writing the ending before the first possession.",
      },
      {
        kind: "p",
        text: "Detroit arrives with its own unfinished sentence. Week 1 already taught Lions fans what a twenty-one-point lead can turn into when the night gets long. That is not a collapse bit for pregame. It is a permission slip: nobody in Honolulu blue gets to use the phrase “comfortable win” unless the scoreboard earns it again.",
      },
      {
        kind: "p",
        text: "Buffalo’s Week 1 late scramble is the mirror. A finish is not the same thing as a finished product. If the home timeline starts selling calm competence before the Lions have the ball, Chip will be in the replies with visiting spoiler energy — and only against a real boast, not a straw man.",
      },
      {
        kind: "p",
        text: "What Chip is watching (one bit, not a buffet):",
      },
      {
        kind: "ul",
        items: [
      ...
      {
        kind: "p",
        text: "What Chip is not stealing:",
      },
      {
        kind: "ul",
        items: [
      ...
      {
        kind: "p",
        text: "Package rule tonight: one Chip sendable joke if the play earns it → plain Desk repost. Empty window beats a filler paragraph. Spent mechanisms stay spent (delete-the-paragraph, parade parking, admin-removal, subject-change — not tonight).",
      },
      {
        kind: "p",
        text: "Losing-fan banter is allowed after the room picks a side: needle #OnePride or #BillsMafia, not both, and never the Raiders/Dolphins/Cardinals deflection lane mid-game. That lane is for hate replies, not the primary post.",
      },
      {
        kind: "p",
        text: "Ceremony is allowed to be loud. Spoilers are allowed to be louder. Engrave nothing before breakfast.",
      },
      {
        kind: "signoff",
        text: "— Poor Form Desk · Chip Absolute on call · SATIRE · Sep 17, 2026",
      },
    ],
  },
  {
    ...
    dek: "Week 2 is not a mandate — every seat filed a rest-of-season ballot before anyone engraves anything.",
    dateLabel: "Sep 17, 2026",
    voiceId: "poor-form-desk",
    body: [
      {
        kind: "p",
        text: "Week 2 is not a mandate. It is a dare. Before the league starts handing out imaginary plaques in September, every seat in the newsroom filed a rest-of-season ballot. One table. Five categories. No committee rewrite of each other’s personality.",
      },
      {
        kind: "p",
        text: "Categories: MVP · Super Bowl champion · Offensive or overall ROY (as each voice defines it) · Coach of the Year · Most disappointing team vs current public expectation.",
      },
      {
        kind: "h2",
        text: "Chip Absolute",
      ...
      {
        kind: "table",
        headers: ["Category", "Pick", "One-line why"],
        rows: [
      ...
      {
        kind: "h2",
        text: "Poor Form Desk (optional house row)",
      },
      {
        kind: "table",
        headers: ["Category", "Pick", "One-line why"],
      ...
      {
        kind: "p",
        text: "Update after Dillon curation. Do not treat as betting advice. Do not engrave.",
      },
      {
        kind: "signoff",
        text: "— Poor Form Desk / SATIRE staff ballot · Sep 17, 2026",
      },
    ],
  },
  {
